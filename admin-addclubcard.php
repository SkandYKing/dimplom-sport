	...
	//добавление карты
		if (!empty($_POST['name']) and !empty($_POST['description']) and !empty($_POST['category']) and !empty($_POST['price'])) {
			...
			if ($i==4) {
				...
				$img = 'cardimg/'.$_FILES['picture']['name'];
				//записывание в бд
				$query2 = "INSERT INTO Card (name,description,category,price,times,img) VALUES('$name','$description','$category','$price','30 дней','$img');";
...
<div class="cent" id="admin">
	...
	<div class="osntx1">
	<div class="trener-prof" id="glav2">
